    ...
    if not st.session_state.autenticado:
        ...
        # === TELA 2: GESTÃO DE AGENDA ===
            ...
            with col1:
                ...
                if not agenda_df.empty:
                    ...
                    for index, row in agenda_df.iterrows():
                        ...
                        mensagem_zap = f"Olá {row['paciente_nome']}, confirmamos sua consulta às {row['horario']}."
            ...
            with col2:
                ...
                st.caption("Dica: Clique no ícone de copiar acima e coloque na bio do Instagram.")
                st.write("")
        ...
        # === TELA 3: FACILITIES E SEGURANÇA ===
            ...
            with col_form:
                ...
                descricao_alerta = st.text_area("Instruções Adicionais:", "Por favor, mantenha a distância.")
        ...
        # === TELA 4: CONFIGURAÇÕES E EQUIPE ===
            ...
            with col_add:
                ...
                with st.form("form_novo_usuario"):
                    ...
                    novo_perfil = st.selectbox("Nível de Acesso", ["Recepcao", "Gestor"])
                    ...
                    if submit_usuario:
                        ...
                        if len(busca_email.data) > 0:
                            ...
                            st.success(f"✅ Conta de '{novo_nome}' criada!")
                            st.rerun()
                        else:
